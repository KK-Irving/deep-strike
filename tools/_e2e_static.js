...
const STREAM_ALLOW = new Set([
  ...
  'waves.js:startWave',
  'game.js:Game>_updateWaveFlow',       // 增援补给/波清(v4.0.2 自 update 拆出,原 update 内消费点随迁)
  ...
  'modes.js:_openDevilOffer',       // 恶魔契约:史诗三选一抽取(玩法随机;恶魔仅普通模式触发,不涉及挑战确定性契约)
  'modes.js:(top-level)',               // 恶魔契约 _devilRollHit:35% 触发概率 roll(Object.assign 内单行方法扫描器栈不识别;普通模式专属玩法随机)
