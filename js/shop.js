...
const SKINS = [
  ...
  { id: 'frost',    name: '霜语',         price: 680,  tier: 0, desc: '极地涂层,冷冽银蓝', hull: '#123a52', stroke: '#c8ecff', cockpit: '#eaf7ff', flame: ['rgba(200,236,255,0.9)', 'rgba(80,160,255,0)'] },
  { id: 'ember',    name: '烈焰',         price: 880,  tier: 0, desc: '熔炉涂层,炽烈橙红', hull: '#4a1810', stroke: '#ff9a3c', cockpit: '#ffd9a8', flame: ['rgba(255,170,90,0.9)', 'rgba(255,60,0,0)'] },
  { id: 'violet',   name: '幽紫',         price: 1280,  tier: 1, desc: '暗夜紫辉,冷艳凌厉', hull: '#2a1240', stroke: '#c86bff', cockpit: '#eadfff', flame: ['rgba(200,107,255,0.9)', 'rgba(90,0,180,0)'], fx: { glow: 1.3, dual: '#7ef3ff' } },
  { id: 'gold',     name: '黄金装甲',     price: 2200, desc: '流光金甲,旗舰级涂装', tier: 2, hull: '#4a3a10', stroke: '#ffd166', cockpit: '#fff3c8', flame: ['rgba(255,220,120,0.9)', 'rgba(255,140,0,0)'], fx: { glow: 1.6, dual: '#fff2b0', sheen: '#fff6cf', trail: 1.4 } },
  ...
  { id: 'emerald',  name: '翠影',         price: 800,  desc: '丛林涂层,幽绿隐蔽',  tier: 0, hull: '#0a3320', stroke: '#5aff9a', cockpit: '#dcffe9', flame: ['rgba(120,255,170,0.9)', 'rgba(0,180,90,0)'] },
  { id: 'rose',     name: '绯樱',         price: 1500, tier: 1, desc: '绯樱纷落,柔中带刺', hull: '#3d1024', stroke: '#ff8fc0', cockpit: '#ffe0ee', flame: ['rgba(255,150,190,0.9)', 'rgba(200,40,110,0)'], fx: { glow: 1.4, dual: '#ffd166' } },
  { id: 'magma',    name: '熔核',         price: 1800, tier: 1, desc: '熔核涌动,炽焰脉搏', hull: '#3a1408', stroke: '#ffb03c', cockpit: '#ffe6c8', flame: ['rgba(255,170,80,0.95)', 'rgba(220,40,0,0)'], fx: { glow: 1.5, dual: '#ff5470' } },
  { id: 'azure',    name: '湛蓝',         price: 3600, desc: '深海静谧,冷光流线', tier: 2, hull: '#0a1e3d', stroke: '#5ab0ff', cockpit: '#dcf0ff', flame: ['rgba(110,190,255,0.9)', 'rgba(30,90,220,0)'], fx: { glow: 1.6, dual: '#aef0ff', sheen: '#e0f2ff', trail: 1.4 } },
  { id: 'thunder',  name: '紫电',         price: 4200, desc: '紫电奔流,高压脉冲', tier: 2, hull: '#1d1040', stroke: '#b08cff', cockpit: '#ece2ff', flame: ['rgba(180,150,255,0.9)', 'rgba(110,40,230,0)'], fx: { glow: 1.7, dual: '#7ef3ff', sheen: '#f0e8ff', trail: 1.5 } },
  { id: 'obsidian', name: '黑曜',         price: 4800, desc: '暗夜无光,隐形涂层', tier: 2, hull: '#101014', stroke: '#8a8fa8', cockpit: '#d8dce8', flame: ['rgba(160,170,200,0.85)', 'rgba(60,70,100,0)'], fx: { glow: 1.7, dual: '#ffd166', sheen: '#e8e8f4', trail: 1.4 } },
  { id: 'frostfire', name: '霜火',       price: 4000, tier: 2, hull: '#0e2436', stroke: '#aef0ff', cockpit: '#ffe0c8', flame: ['rgba(174,240,255,0.95)', 'rgba(255,90,40,0)'], desc: '极温对撞:冰晶机身嵌熔核纹路', fx: { glow: 1.8, dual: '#ff7a3c', sheen: '#e8f6ff', trail: 1.7 } },
  { id: 'dawn',      name: '曙光',       price: 4400, tier: 2, hull: '#332a08', stroke: '#ffe28a', cockpit: '#fff6d0', flame: ['rgba(255,220,120,0.95)', 'rgba(120,200,80,0)'], desc: '创世曙光:金辉渐染新绿晨光', fx: { glow: 1.8, dual: '#9dff5a', sheen: '#fff8dc', trail: 1.7 } },
  { id: 'crimson',  name: '猩红之刃',     ach: 'combo_60', tier: 1, desc: '连击 60 的鲜血证章', hull: '#40101d', stroke: '#ff4d6d', cockpit: '#ffd6de', flame: ['rgba(255,110,130,0.9)', 'rgba(180,0,40,0)'], fx: { glow: 1.4, dual: '#ffd166' } },
  { id: 'abyss',    name: '深渊指挥官',   ach: 'wave_20',  tier: 2, desc: '抵达第 20 波的深渊统帅权柄', hull: '#06282a', stroke: '#2be8c8', cockpit: '#c8fff4', flame: ['rgba(80,230,200,0.9)', 'rgba(0,120,140,0)'], fx: { glow: 1.6, dual: '#7effe0', sheen: '#c8fff4', trail: 1.4 } },
  { id: 'evoProto', name: '进化原型机',   ach: 'evo_3',    tier: 1, desc: '三次进化的活体标本', hull: '#12240a', stroke: '#9dff5a', cockpit: '#e8ffd6', flame: ['rgba(157,255,90,0.9)', 'rgba(40,140,0,0)'], fx: { glow: 1.4, dual: '#e8ffd6' } },
  { id: 'phantomX', name: '幽灵X',        ach: 'boss_10',  tier: 2, desc: '十艘旗舰猎杀者的幽影', hull: '#1a1a2e', stroke: '#8fa8ff', cockpit: '#dfe8ff', flame: ['rgba(143,168,255,0.8)', 'rgba(40,60,180,0)'], fx: { glow: 1.6, dual: '#c8d4ff', sheen: '#dfe8ff', trail: 1.3 } },
  ...
  { id: 'eventhorizon', name: '视界·黑洞', rare: true, tier: 3, hull: '#0a0a14', stroke: '#b8a8ff', cockpit: '#ece6ff', flame: ['rgba(190,160,255,0.95)', 'rgba(60,0,140,0)'], desc: '★绚丽·仅密匣/兑换获得 · 黑洞视界吸积环', fx: { glow: 2.6, dual: '#6a4aff', sheen: '#efe8ff', trail: 2.2, anim: 'horizon' } },
  { id: 'skyfall',  name: '苍雷·天罚',   rare: true, tier: 3, hull: '#101c3a', stroke: '#8fdcff', cockpit: '#e6f6ff', flame: ['rgba(140,220,255,0.95)', 'rgba(0,80,200,0)'], desc: '★绚丽·仅密匣/兑换获得 · 天罚雷链环绕', fx: { glow: 2.5, dual: '#ffe98a', sheen: '#eaf6ff', trail: 2.3, anim: 'thorchain' } },
...
const SHIPS = [
  ...
  { id: 'lancer',    name: '锐锋狙击',   price: 3600, desc: '狙击型:高伤慢射,内置 10% 暴击', hp: 90,  speed: 320, fire: 0.16,  dmgBonus: 2, perkCrit: 1 },
  ...
  { id: 'wasp',      name: '黄蜂',       price: 3800, desc: '蜂刺型:全库最快射速,贴脸收割', hp: 85,  speed: 390, fire: 0.085, dmgBonus: 0, perkMagnet: 30 },
  ...
  { id: 'fortress2', name: '堡垒·改',    price: 5800, desc: '要塞型:重甲自愈,阵地之王(自带 0.8/秒 修复)', hp: 130, speed: 310, fire: 0.13,  dmgBonus: 0, perkArmor: 0.08, perkRegen: 0.8 },
  { id: 'zenith',    name: '天顶',       price: 6400, desc: '天顶型:全能平衡,自带侧翼', hp: 105, speed: 360, fire: 0.10,  dmgBonus: 1, perkSide: 1, perkMagnet: 20 },
  { id: 'shard',     name: '裂片',       price: 3400, desc: '裂片型:天生裂变,弹弹开花',   hp: 95,  speed: 345, fire: 0.115, dmgBonus: 1, perkSplit: 1 },
  { id: 'tide',      name: '潮汐',       price: 3900, desc: '潮汐型:天生时滞力场,弹幕减速 10%', hp: 110, speed: 335, fire: 0.115, dmgBonus: 0, perkTime: 1 },
  ...
  { id: 'riftblade', name: '裂空',       rare: true, desc: '★绚丽机体:空间裂隙环绕,极限输出 · 仅密匣/兑换获得', hp: 100, speed: 375, fire: 0.09, dmgBonus: 3, perkSide: 1, fx: { glow: 2.4, dual: '#7affd4', sheen: '#eafff6', trail: 2.2, anim: 'rift', shipTier: 3 } },
  { id: 'winterwind', name: '永冬',      rare: true, desc: '★绚丽机体:寒霜新星环绕,控场生存 · 仅密匣/兑换获得', hp: 115, speed: 350, fire: 0.10, dmgBonus: 2, perkArmor: 0.08, fx: { glow: 2.3, dual: '#aef0ff', sheen: '#eef8ff', trail: 2.0, anim: 'frostnova', shipTier: 3 } },
...
const SHIP_SHAPES = {
  ...
  shard:     (g) => { g.moveTo(0, -18); g.lineTo(6, -8); g.lineTo(4, 0); g.lineTo(12, 6); g.lineTo(4, 8); g.lineTo(0, 14); g.lineTo(-4, 8); g.lineTo(-12, 6); g.lineTo(-4, 0); g.lineTo(-6, -8); g.closePath(); },
  tide:      (g) => { g.moveTo(0, -15); g.bezierCurveTo(10, -12, 12, -2, 10, 4); g.bezierCurveTo(8, 10, 4, 12, 0, 13); g.bezierCurveTo(-4, 12, -8, 10, -10, 4); g.bezierCurveTo(-12, -2, -10, -12, 0, -15); g.closePath(); },
...
const BOOSTS = [
  ...
  { id: 'spd0',   icon: '💨', name: '推进矩阵',   desc: '移动速度 +1.5%/级(满级 +15%)',
    prices: [420, 680, 1000, 1400, 1880, 2450, 3120, 3900, 4800, 5850], per: '+1.5% 移速' },
  { id: 'rate0',  icon: '🔥', name: '射频调谐',   desc: '射击间隔 -1.2%/级(满级 -12%)',
    prices: [520, 840, 1240, 1740, 2340, 3050, 3880, 4850, 5980, 7280], per: '-1.2% 射击间隔' },
  { id: 'crit0',  icon: '✖',  name: '要害校准',   desc: '暴击率 +1%/级(满级 +10%)',
    prices: [700, 1120, 1640, 2300, 3080, 4000, 5080, 6340, 7800, 9500], per: '+1% 暴击' },
  { id: 'evade0', icon: '✦',  name: '相位引擎',   desc: '闪避冲刺冷却 -0.1s/级(满级 -1s)',
    prices: [550, 880, 1300, 1820, 2440, 3180, 4040, 5050, 6220, 7580], per: '-0.1s 冲刺冷却' }
];
/* 读取某强化的当前等级(兼容旧布尔存档) */
...
const LOADOUTS = [
  ...
  { id: 'aegis0', icon: '📦', name: '空投呼叫', desc: '下次出击立即空投 2 个补给道具', price: 40 }
];
